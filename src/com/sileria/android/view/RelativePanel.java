...
/**
 * An extension of {@code RelativeLayout} that allows you to get a callback
 ...
 * @date 12/31/10
 */
public class RelativePanel extends RelativeLayout {
	...
	public RelativePanel (Context context, AttributeSet attrs) {
		super( context, attrs );
	}

	public RelativePanel (Context context, AttributeSet attrs, int defStyle) {
